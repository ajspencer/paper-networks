...
#     print "classification result from fold($testp)-class($clsNO)-$printstr\:\n";
    #All of these variables are binaries, and are located in the following places
    #classifier: /bin/../svm-light/svm_classify
    #testF: /bin/../tmp/tmpVec_0_test2
    #SVModelF: /bin/../resources/models/4Modelfold1
    #mySVMREsult: /tmp/tmpresult_0_2\, this one hasn't been created because this system call isn't working and that's the problem
